				...
				<div style={{ display:'grid', gap:12 }}>
					...
					<section style={{ border:'1px solid var(--accent)', borderRadius:6, padding:8 }}>
						...
						<div style={{ display:'grid', gridTemplateColumns:'140px 1fr', gap:12, alignItems:'center', marginTop:8 }}>
							<div style={{ width:140, height:140, border:'1px solid var(--accent)', borderRadius:8, background:'#102', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden' }}>
								{trainerImage ? (
