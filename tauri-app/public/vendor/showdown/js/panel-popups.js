...
AvatarsPanel=function(_PSRoomPanel7){function AvatarsPanel(){var _this11;for(var _len6=arguments.length,args=new Array(_len6),_key6=0;_key6<_len6;_key6++){args[_key6]=arguments[_key6];}_this11=_PSRoomPanel7.call.apply(_PSRoomPanel7,[this].concat(args))||this;_this11.




setLocalAvatar=function(ev){var _this11$base;
ev.preventDefault();
var id=(_this11$base=_this11.base)==null||(_this11$base=_this11$base.querySelector('input[name="localavatar"]'))==null||(_this11$base=_this11$base.value)==null?void 0:_this11$base.trim();
if(!id)return;
PS.user.avatar="#"+toID(id);
PS.user.update(null);
_this11.close();
};return _this11;}_inheritsLoose(AvatarsPanel,_PSRoomPanel7);var _proto9=AvatarsPanel.prototype;_proto9.
...
preact.h("hr",null),
preact.h("div",null,
preact.h("p",null,preact.h("strong",null,"Use a local image (client-only)")),
preact.h("p",{"class":"message-thin"},"Place a PNG at ",
preact.h("code",null,"sprites/trainers-custom/<id>.png"),", then enter the id below. This only changes how your client displays your avatar."
),
preact.h("p",null,
preact.h("input",{name:"localavatar","class":"textbox",style:"width:220px",placeholder:"custom-id (e.g. myavatar)"})," ",
preact.h("button",{"class":"button",onClick:this.setLocalAvatar},"Use local image")
)
),
...
ReplacePlayerPanel=function(_PSRoomPanel9){function ReplacePlayerPanel(){var _this12;for(var _len7=arguments.length,args=new Array(_len7),_key7=0;_key7<_len7;_key7++){args[_key7]=arguments[_key7];}_this12=_PSRoomPanel9.call.apply(_PSRoomPanel9,[this].concat(args))||this;_this12.





handleReplacePlayer=function(ev){var _room$getParent,_this12$base;
var room=_this12.props.room;
var battleRoom=(_room$getParent=room.getParent())==null?void 0:_room$getParent.getParent();
var newPlayer=(_this12$base=_this12.base)==null||(_this12$base=_this12$base.querySelector("input[name=newplayer]"))==null?void 0:_this12$base.value;
...
_this12.close();
ev.preventDefault();
};return _this12;}_inheritsLoose(ReplacePlayerPanel,_PSRoomPanel9);var _proto11=ReplacePlayerPanel.prototype;_proto11.
...
ChangePasswordPanel=function(_PSRoomPanel10){function ChangePasswordPanel(){var _this13;for(var _len8=arguments.length,args=new Array(_len8),_key8=0;_key8<_len8;_key8++){args[_key8]=arguments[_key8];}_this13=_PSRoomPanel10.call.apply(_PSRoomPanel10,[this].concat(args))||this;_this13.
...
handleChangePassword=function(ev){var _this13$base,_this13$base2,_this13$base3;
ev.preventDefault();
var oldpassword=(_this13$base=_this13.base)==null||(_this13$base=_this13$base.querySelector('input[name=oldpassword]'))==null?void 0:_this13$base.value;
...
if(data!=null&&data.actionerror)return _this13.setState({errorMsg:data==null?void 0:data.actionerror});
...
};return _this13;}_inheritsLoose(ChangePasswordPanel,_PSRoomPanel10);var _proto12=ChangePasswordPanel.prototype;_proto12.
...
RegisterPanel=function(_PSRoomPanel11){function RegisterPanel(){var _this14;for(var _len9=arguments.length,args=new Array(_len9),_key9=0;_key9<_len9;_key9++){args[_key9]=arguments[_key9];}_this14=_PSRoomPanel11.call.apply(_PSRoomPanel11,[this].concat(args))||this;_this14.
...
handleRegisterUser=function(ev){var _this14$base,_this14$base2,_this14$base3;
ev.preventDefault();
var captcha=(_this14$base=_this14.base)==null||(_this14$base=_this14$base.querySelector('input[name=captcha]'))==null?void 0:_this14$base.value;
...
if(data!=null&&data.actionerror)_this14.setState({errorMsg:data==null?void 0:data.actionerror});
...
};return _this14;}_inheritsLoose(RegisterPanel,_PSRoomPanel11);var _proto13=RegisterPanel.prototype;_proto13.
...
BackgroundListPanel=function(_PSRoomPanel12){function BackgroundListPanel(){var _this15;for(var _len10=arguments.length,args=new Array(_len10),_key10=0;_key10<_len10;_key10++){args[_key10]=arguments[_key10];}_this15=_PSRoomPanel12.call.apply(_PSRoomPanel12,[this].concat(args))||this;_this15.
...
if(bg==='custom'){var _this15$props$room$ar;
PSBackground.set(((_this15$props$room$ar=_this15.props.room.args)==null?void 0:_this15$props$room$ar.bgUrl)||'','custom');
_this15.close();
}else{
PSBackground.set('',bg);
}
...
ChatFormattingPanel=function(_PSRoomPanel13){function ChatFormattingPanel(){var _this16;for(var _len11=arguments.length,args=new Array(_len11),_key11=0;_key11<_len11;_key11++){args[_key11]=arguments[_key11];}_this16=_PSRoomPanel13.call.apply(_PSRoomPanel13,[this].concat(args))||this;_this16.
...
ev.preventDefault();
ev.stopImmediatePropagation();
};return _this16;}_inheritsLoose(ChatFormattingPanel,_PSRoomPanel13);var _proto15=ChatFormattingPanel.prototype;_proto15.
...
BattleOptionsPanel=function(_PSRoomPanel15){function BattleOptionsPanel(){var _this17;for(var _len12=arguments.length,args=new Array(_len12),_key12=0;_key12<_len12;_key12++){args[_key12]=arguments[_key12];}_this17=_PSRoomPanel15.call.apply(_PSRoomPanel15,[this].concat(args))||this;_this17.
...
var room=_this17.getBattleRoom();
if(!room)return _this17.close();
...
_this17.handleIgnoreOpponent(value);
break;
}
case'ignorespects':{
PS.prefs.set('ignorespects',value);
_this17.handleIgnoreSpectators(value);
break;
}
case'ignorenicks':{
PS.prefs.set('ignorenicks',value);
_this17.handleIgnoreNicks(value);
break;
}
case'rightpanel':{
...
};return _this17;}_inheritsLoose(BattleOptionsPanel,_PSRoomPanel15);var _proto17=BattleOptionsPanel.prototype;_proto17.
...
PopupRoom=function(_PSRoom2){function PopupRoom(){var _this18$args;var _this18;for(var _len13=arguments.length,args=new Array(_len13),_key13=0;_key13<_len13;_key13++){args[_key13]=arguments[_key13];}_this18=_PSRoom2.call.apply(_PSRoom2,[this].concat(args))||this;_this18.
returnValue=(_this18$args=_this18.args)==null?void 0:_this18$args.cancelValue;return _this18;}_inheritsLoose(PopupRoom,_PSRoom2);var _proto18=PopupRoom.prototype;_proto18.
...
PopupPanel=function(_PSRoomPanel16){function PopupPanel(){var _this19;for(var _len14=arguments.length,args=new Array(_len14),_key14=0;_key14<_len14;_key14++){args[_key14]=arguments[_key14];}_this19=_PSRoomPanel16.call.apply(_PSRoomPanel16,[this].concat(args))||this;_this19.
...
ev.preventDefault();
ev.stopImmediatePropagation();
var room=_this19.props.room;
room.returnValue=(_room$args3=room.args)==null?void 0:_room$args3.okValue;
var textbox=_this19.base.querySelector('input[name=value]');
if(textbox){
room.returnValue=textbox.value;
}
_this19.close();
};return _this19;}_inheritsLoose(PopupPanel,_PSRoomPanel16);var _proto19=PopupPanel.prototype;_proto19.
...
RoomTabListPanel=function(_PSRoomPanel17){function RoomTabListPanel(){var _this20;for(var _len15=arguments.length,args=new Array(_len15),_key15=0;_key15<_len15;_key15++){args[_key15]=arguments[_key15];}_this20=_PSRoomPanel17.call.apply(_PSRoomPanel17,[this].concat(args))||this;_this20.





startingLayout=PS.prefs.onepanel;_this20.
handleLayoutChange=function(ev){
var checkbox=ev.currentTarget;
PS.prefs.onepanel=checkbox.checked?'vertical':_this20.startingLayout;
PS.update();
};return _this20;}_inheritsLoose(RoomTabListPanel,_PSRoomPanel17);var _proto20=RoomTabListPanel.prototype;_proto20.
render=function render(){
...
componentDidMount=function componentDidMount(){var _this21=this;
...
var timeLeft=_this21.state.timeLeft||5;
var canClose=timeLeft===1;
_this21.setState({canClose:canClose,timeLeft:timeLeft-1});
if(canClose){
clearInterval(_this21.state.timerRef);
_this21.setState({timerRef:null});
}
},1000);
