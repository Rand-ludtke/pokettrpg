...
PS.teams.list=[];
PS.teams.byKey={};for(var _i2=0;_i2<
teams.length;_i2++){var team=teams[_i2];PS.teams.push(team);}
...
var folderTable={'':1};
var folders=[];for(var _i4=0,_PS$teams$list2=
PS.teams.list;_i4<_PS$teams$list2.length;_i4++){var team=_PS$teams$list2[_i4];
...
var gen=-1;for(var _i6=0;_i6<
folders.length;_i6++){var _format=folders[_i6];
