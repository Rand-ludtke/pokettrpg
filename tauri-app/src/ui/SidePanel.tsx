...
const TYPE_CHART: Record<string, Record<string, number>> = {
  ...
  stellar: { bug: 2, rock: 2, fire: 2, water: 2, electric: 2, grass: 2, ice: 2, fighting: 2, poison: 2, ground: 2, flying: 2, psychic: 2, ghost: 2, dark: 2, dragon: 0.5, steel: 0.5, fairy: 2, cosmic: 0.5, nuclear: 0.5, crystal: 0.5, light: 0.5, shadow: 0.5, stellar: 0.5 },
  '???': {},
};
